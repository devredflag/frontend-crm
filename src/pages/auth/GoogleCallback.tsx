...
export default function GoogleCallback() {
  ...
  return (
    <div style={{ display:"flex", alignItems:"center", justifyContent:"center", height:"100vh", background:FUNDO_AZUL.background, backgroundSize: FUNDO_AZUL.backgroundSize, fontFamily:"sans-serif" }}>
      <div style={{ background:"rgba(18,59,94,0.55)", borderRadius:20, padding:"40px 48px", textAlign:"center", boxShadow:"0 8px 40px rgba(66,133,244,0.15)", maxWidth:360 }}>
        {status === "loading" && (
          <>
            ...
            <div style={{ fontSize:16, fontWeight:700, color:"#EAF6FB" }}>Conectando Google...</div>
